              ...
              <div className="volunteering-about">
                <div className="volunteering-officedetails">
                  ...
                  <div className="volunteering_body">
                    <p>• Organized the largest hackathon of our college named as Ureckathon with 650+ registrations.</p>
                    <p>
                ...
                <div className="volunteering-officedetails">
                  ...
                  <div className="volunteering_body">
                    ...
                    <p>
                      ...
                      <a href="https://buildersofweb3.xyz/ccu/">here</a>.
                    </p>
                  </div>
                </div>
                <div className="volunteering-officedetails">
                ...
                <div className="volunteering-officedetails">
                  ...
                  <div className="volunteering_body">
                    <p>
                      • Built the official website of this event using ReactJS
                      and CSS.
                    </p>
                    <p>• Worked on the Frontend part.</p>
                    <p>
                      • Site is live{" "}
                      <a href="https://uemcyclothon.uem.edu.in/">here</a>.
                    </p>
                  </div>
                </div>
                ...
                <div className="volunteering-officedetails">
                  ...
                  <div className="volunteering_body">
                    <p>
                      • Instructed 250+ students of multiple batches to
                      reinforce learning concepts on "Web Development" through
                      workshop.
                    </p>
                    <p>• Taught 150+ students about Git & GitHub.</p>
                    <p>
                      • Organizing workshops and technical events in
                      collaboration with different colleges.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="volunteering-box">
              ...
              <div className="volunteering-about">
                <div className="volunteering-officedetails">
                  ...
                  <div className="volunteering_body">
                    <p>
                      • Working as a full-stack developer with React, MongoDB,
                      NodeJS, ExpressJS.
                    </p>
                    <p>
                      • Building the official website which will be used by
                    ...
                    <p>
                      • Conducting Technical Workshops at UEM, Kolkata with 200+
                      attendees.
                    </p>
                  </div>
                </div>
