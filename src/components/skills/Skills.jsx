  ...
  return (
    <div className="skills" id="skillsme">
      ...
      <div className="title_down">
        <hr className="line" />
        <span className="title_after">what I know</span>
      </div>
      ...
      <div className="skills_content">
        <div className="skills_boxes">
          ...
          <div className="skills_box">
            ...
            <div className="skills_box_contentbody">
              <p>
                I design elegantly beautiful, yet minimal web designs for the
                users.{" "}
              </p>
            </div>
          </div>
          <div className="skills_box">
            ...
            <div className="skills_box_contentbody">
              <p>
                I'm also a programmer who solves DSA-related problems every day.{" "}
              </p>
            </div>
          </div>
          <div className="skills_box">
